...
const Alerts = () => {
  ...
  const apiOffroadAlert = `${mainAPI}/Api/Admin/Alerts/OFFROAD`;
  const apiAccidentAlert = `${mainAPI}/Api/Admin/Alerts/ACCIDENT`;
  const apiDriverAlert = `${mainAPI}/Api/Admin/Alerts/DRIVER`;
